...
**APPROVAL BATCH additions:** run_tests.py later += `tests.contract.test_workflow_recovery_matrix` (currently exercised via the bridge import at the bottom of test_workflow_contract.py).

**NEXT (all unblocked):** RKIT-I-0011 (career-mcp semantics), RKIT-I-0009/0010 (career-mcp base), I-0016 (resume-agent foundation), I-0029/0033/0035/0047. Same loop (§4).

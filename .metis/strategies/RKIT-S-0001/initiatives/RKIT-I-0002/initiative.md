...
updated_at: 2026-08-13T20:41:36.852663+00:00
...
Outcome: Deterministic official match results with explainable requirement-level states where hard requirements, aliases, verified facts, related matches, possible matches, and explicit absence remain distinct.
...
### System Requirements
- Never let related or possible matches count as resolved hard requirements by default.
- Repeated scoring with identical inputs returns equivalent output.
...
- Resolution engine
- Requirement result DTOs
- Job A/Job B scoring fixture snapshots

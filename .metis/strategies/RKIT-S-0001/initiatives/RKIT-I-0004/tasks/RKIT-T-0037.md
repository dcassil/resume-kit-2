...
- 2026-08-14: Activated after T-0036 committed (general honesty mechanism verified by driver probes: lookup-neutralized fabrication rejection, ladder, word↔digit quantities, subject-scoped years; gates 307/smoke green). Codex launched with binding decisions: guardrails_config.py mirroring matching/resume config precedents, flat allow_inferred_facts removal with full caller sweep, compose-rule floor, all-terms stuffing fix, generalized duplicates. Prompt at scratchpad t0037-prompt.md.
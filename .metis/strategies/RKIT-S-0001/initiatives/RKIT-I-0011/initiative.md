...
updated_at: 2026-08-13T20:41:37.059367+00:00
...
Package: `career-mcp`. This initiative is part of the Resume Kit 2 full product buildout under `RKIT-S-0001`. Current contracts and guardrails pass for the scaffold, but this initiative captures product-depth work before task-level decomposition.

Outcome: MCP exposes store facts, verification, relationships, conflicts, and matches without inventing alternate semantics.
...
### System Requirements
- No raw SQL, scoring, resume mutation, or plugin presentation behavior.
- Responses distinguish verified, related, possible, unknown, and missing states.

### Dependencies
- Relationship-Aware Matching and Cross-Job Reuse
- Harden Career-MCP Tool Argument Validation and Response Normalization
...
- Policy and DTO normalization
- Smoke/E2E MCP fixtures

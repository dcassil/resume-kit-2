...
- 2026-08-16: T-0085 committed (real-store tier all 8 tools, verified-fake conformance, imported end-to-end; gates 440/smoke/verify green). NOTE: T-0085 included a small career-store change — verifyFact now routes import/inference structural authorities from provenance refs (engine still gates; driver probed that imported WITHOUT anchored provenance is still rejected). Codex launched on this close-out task.
...
Outcome: career-mcp can run as a real MCP server rather than only as an in-process adapter.
...
### Dependencies
- Implement Career-MCP Mutation Audit and Operation Traceability

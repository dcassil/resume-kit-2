...
Outcome: Markdown and DOCX outputs preserve canonical resume semantics, section order, titles, dates, skills, bullets, and ATS-safe text.
...
### Dependencies
- Resume-Render Template and Result Contract Hardening

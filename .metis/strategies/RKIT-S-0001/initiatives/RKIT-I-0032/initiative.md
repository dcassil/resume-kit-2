...
Outcome: Rendered output validation detects unreadable output, missing sections, unsupported characters, and material semantic loss.
...
### Dependencies
- Resume-Render Layout Measurement and Overflow Constraint Reporting

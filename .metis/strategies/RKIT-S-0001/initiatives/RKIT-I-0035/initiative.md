...
Outcome: resume_cli.main is a robust local reference entrypoint with stable workspace, config, result, and error behavior.
...
### Dependencies
- Workflow-Backed Smoke and E2E Acceptance Coverage

...
Outcome: CLI delegates ingest parsing, sanitation, normalization, validation, provenance, and persistence to owning packages and writes faithful artifacts.
...
### Dependencies
- Resume CLI Runtime and Workspace Contract

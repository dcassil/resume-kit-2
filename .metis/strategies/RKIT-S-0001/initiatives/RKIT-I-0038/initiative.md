...
Outcome: CLI orchestrates tailoring as proposal, validation, application, and audit while preserving base immutability.
...
### Dependencies
- Deterministic Match, Resolve, and Inspect UX

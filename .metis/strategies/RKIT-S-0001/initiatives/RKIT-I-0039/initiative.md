...
Outcome: CLI validates final resume truth and invokes renderer outputs without allowing rendering to change semantic content.
...
### Dependencies
- Grounded Tailoring Operation Lifecycle

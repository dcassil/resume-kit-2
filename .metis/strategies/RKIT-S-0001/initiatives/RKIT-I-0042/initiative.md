...
Outcome: A real loadable host/plugin bundle exists with manifest metadata, tool and skill entry points, and version/config reporting.
...
### Dependencies
- Persistent Multi-Job CLI Flow and Release Acceptance

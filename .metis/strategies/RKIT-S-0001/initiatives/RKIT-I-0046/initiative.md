...
Outcome: Plugin presents code-selected confirmation requests and captures answers with minimal context for public resolution workflow.
...
### Dependencies
- Plugin Conversation-to-Workflow Mapping and Run Context

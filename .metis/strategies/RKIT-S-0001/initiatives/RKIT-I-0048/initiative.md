...
Outcome: resume-plugin can be installed, packaged, versioned, and upgraded without changing resume truth semantics.
...
### Dependencies
- Plugin Diff, Report, Export, and Audit Presentation
